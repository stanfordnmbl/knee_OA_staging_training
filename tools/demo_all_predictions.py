...
def predict_vis_detect(scores, boxes, im_name, model = 'avg'):
    ...
    if model == 'avg':
        ...
        filename = '/home/suhas/output_models/classification_models/SVM.sav'
    elif model == 'Random_forest':
        filename = '/home/suhas/output_models/classification_models/Random_forest.sav'
    elif model == 'MLP':
        filename = '/home/suhas/output_models/classification_models/MLP_15_10.sav'
    else:
    ...
    plt.savefig('/home/suhas/code_repo/py-faster-rcnn/output/output_test_images/' + im_name)
...
if __name__ == '__main__':
    ...
    im_names = []
    for file in os.listdir('/home/suhas/code_repo/py-faster-rcnn/data/test_images'):
